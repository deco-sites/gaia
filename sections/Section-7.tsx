    ...
    <section class="bg-black" id="contato">
        <div class="container min-h-[80vh] flex justify-center items-center py-[250px] md:py-[275px]">
            <div class="w-full grid justify-center">
                ...
                <div class="flex gap-2 border-b-2 pb-2 border-[#ffffff66] mt-[60px] max-w-[635px]">
                    <input type="text" placeholder="Digite seu e-mail" class="flex-1 bg-transparent text-[#ffffff66] focus:outline-0 placeholder:text-[#F9F9F930]" />
